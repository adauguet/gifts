...
var author$project$Compute$validate = F2(
	function (forbidden, solution) {
		return !A2(
			elm$core$List$any,
			...
			A2(
				elm$core$List$map,
				function (link) {
					return A2(elm$core$List$member, link, forbidden);
				},
				solution));
	});
var author$project$Input$toPersons = function (input) {
	if (input.$ === 'Single') {
		var p = input.a;
		return _List_fromArray(
			[p]);
...
var elm_community$list_extra$List$Extra$select = function (list) {
	if (!list.b) {
		return _List_Nil;
	} else {
		var x = list.a;
		...
		return A2(
			...
			A2(
				...
				elm_community$list_extra$List$Extra$select(xs)));
	}
};
var elm_community$list_extra$List$Extra$permutations = function (xs_) {
	if (!xs_.b) {
		return _List_fromArray(
			[_List_Nil]);
	} else {
		...
		var f = function (_n1) {
			...
			return A2(
				...
				elm_community$list_extra$List$Extra$permutations(ys));
		};
		return A2(
...
var author$project$Compute$compute = F2(
	function (inputs, forbidden) {
		return A2(
			elm$random$Random$map,
			elm_community$list_extra$List$Extra$find(
				author$project$Compute$validate(forbidden)),
			elm_community$random_extra$Random$List$shuffle(
				A2(
					elm$core$List$map,
					author$project$Link$fromPersons,
					elm_community$list_extra$List$Extra$permutations(
						elm$core$List$concat(
							A2(elm$core$List$map, author$project$Input$toPersons, inputs))))));
	});
...
var author$project$Main$GotResults = function (a) {
	return {$: 'GotResults', a: a};
};
...
var author$project$Main$alreadyExisting = F2(
	function (inputs, input) {
		var persons = elm$core$Set$fromList(
			author$project$Input$toPersons(input));
		var list = elm$core$Set$fromList(
			elm$core$List$concat(
				A2(elm$core$List$map, author$project$Input$toPersons, inputs)));
		return elm$core$Set$toList(
			A2(elm$core$Set$intersect, persons, list));
	});
			...
			switch (_n0.b.$) {
				...
				case 'OnClickCompute':
					if (_n0.a.$ === 'Default') {
						var _n8 = _n0.a;
						var _n9 = _n0.b;
						var couples = elm$core$List$concat(
							A2(elm$core$List$map, author$project$Link$fromInput, model.inputs));
						return _Utils_Tuple2(
							model,
							A2(
								elm$random$Random$generate,
								author$project$Main$GotResults,
								A2(author$project$Compute$compute, model.inputs, couples)));
					} else {
						break _n0$9;
					}
				case 'GotResults':
					if (_n0.a.$ === 'Default') {
						var _n10 = _n0.a;
						var maybeResult = _n0.b.a;
						if (maybeResult.$ === 'Nothing') {
							return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
						} else {
							var links = maybeResult.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										state: author$project$Main$Results(links)
									}),
								elm$core$Platform$Cmd$none);
						}
					} else {
