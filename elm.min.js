...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{input: '', inputLeft: '', inputRight: '', inputs: _List_Nil, state: author$project$Main$Default},
...
var author$project$Person$canOffer = F3(
	function (pairs, p1, p2) {
		return !(A2(
...
var author$project$Algo$close = F2(
	function (pairs, chain) {
		var _n0 = _Utils_Tuple2(
			elm$core$List$head(chain),
			elm$core$List$head(
				elm$core$List$reverse(chain)));
		if ((_n0.a.$ === 'Just') && (_n0.b.$ === 'Just')) {
			var first = _n0.a.a;
			var last = _n0.b.a;
			if (A3(author$project$Person$canOffer, pairs, first, last)) {
				return chain;
			} else {
				var _n1 = elm$core$List$reverse(chain);
				if (_n1.b && _n1.b.b) {
					var a = _n1.a;
					var _n2 = _n1.b;
					var b = _n2.a;
...
var author$project$Algo$compute = F2(
	function (pairs, _n0) {
		compute:
		while (true) {
			var chain = _n0.chain;
			...
			var bin = _n0.bin;
			if (!pool.b) {
				return {bin: bin, chain: chain, pool: pool};
			} else {
				var pick = pool.a;
				var tail = pool.b;
				if (!chain.b) {
					var $temp$pairs = pairs,
						$temp$_n0 = {
						bin: _List_Nil,
						chain: _List_fromArray(
							[pick]),
						pool: tail
					};
					pairs = $temp$pairs;
					...
					var last = chain.a;
					if (A3(author$project$Person$canOffer, pairs, last, pick)) {
						var $temp$pairs = pairs,
							$temp$_n0 = {
							bin: _List_Nil,
							chain: A2(elm$core$List$cons, pick, chain),
							pool: A2(elm$core$List$append, tail, bin)
						};
						pairs = $temp$pairs;
						_n0 = $temp$_n0;
						continue compute;
						...
						var $temp$pairs = pairs,
							$temp$_n0 = {
							bin: A2(elm$core$List$cons, pick, bin),
							chain: chain,
							pool: tail
						};
						pairs = $temp$pairs;
...
var author$project$Algo$run = F2(
	function (pairs, persons) {
		var result = A2(
			author$project$Algo$compute,
			pairs,
			{bin: _List_Nil, chain: _List_Nil, pool: persons});
		var _n0 = _Utils_Tuple2(result.bin, result.pool);
		if ((!_n0.a.b) && (!_n0.b.b)) {
			return A2(author$project$Algo$close, pairs, result.chain);
		} else {
			return _List_Nil;
		}
	});
...
var author$project$Helpers$shuffle = function (arr) {
	if (elm$core$List$isEmpty(arr)) {
...
var author$project$Input$toCouple = function (input) {
	if (input.$ === 'Single') {
		return elm$core$Maybe$Nothing;
	} else {
		var p1 = input.a;
...
var author$project$Input$toCouples = function (inputs) {
	return A2(
		elm$core$List$filterMap,
		elm$core$Basics$identity,
		A2(elm$core$List$map, author$project$Input$toCouple, inputs));
};
var elm$core$List$concat = function (lists) {
	return A3(elm$core$List$foldr, elm$core$List$append, _List_Nil, lists);
};
var author$project$Input$toPersons = function (inputs) {
	var inputToPersons = function (input) {
		if (input.$ === 'Single') {
			var p = input.a;
			return _List_fromArray(
				[p]);
	...
	return elm$core$List$concat(
		A2(elm$core$List$map, inputToPersons, inputs));
};
var author$project$Main$AddCouple = {$: 'AddCouple'};
var author$project$Main$AddSingle = {$: 'AddSingle'};
var author$project$Main$GotRandomPersons = function (a) {
	return {$: 'GotRandomPersons', a: a};
};
		...
		switch (msg.$) {
			...
			case 'OnClickAddCouple':
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 'OnClickAddSingleCancel':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{input: '', state: author$project$Main$Default}),
					elm$core$Platform$Cmd$none);
			case 'OnClickAddCoupleCancel':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{inputLeft: '', inputRight: '', state: author$project$Main$Default}),
					elm$core$Platform$Cmd$none);
			case 'OnClickAddSingleConfirm':
				var _n1 = model.input;
				if (_n1 === '') {
						...
						_Utils_update(
							model,
							{
								...
								inputs: A2(
									...
									_List_fromArray(
										[
											author$project$Input$Single(p)
										])),
								state: author$project$Main$Default
							}),
						elm$core$Platform$Cmd$none);
				}
			case 'OnClickAddCoupleConfirm':
				var _n2 = _Utils_Tuple2(model.inputLeft, model.inputRight);
				if (_n2.a === '') {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				} else {
					if (_n2.b === '') {
							...
							_Utils_update(
								model,
								{
									...
									inputs: A2(
										...
										_List_fromArray(
											[
												A2(author$project$Input$Couple, p1, p2)
											])),
									state: author$project$Main$Default
								}),
							elm$core$Platform$Cmd$none);
			...
			case 'OnClickCompute':
				return _Utils_Tuple2(
					...
					A2(
						elm$random$Random$generate,
						author$project$Main$GotRandomPersons,
						author$project$Helpers$shuffle(
							author$project$Input$toPersons(model.inputs))));
			case 'GotRandomPersons':
				var persons = msg.a;
				var couples = author$project$Input$toCouples(model.inputs);
				var chain = A2(author$project$Algo$run, couples, persons);
				return elm$core$List$isEmpty(chain) ? _Utils_Tuple2(model, elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							state: author$project$Main$Results(chain)
						}),
					elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
...
var author$project$Main$OnClickAddCoupleCancel = {$: 'OnClickAddCoupleCancel'};
var author$project$Main$OnClickAddCoupleConfirm = {$: 'OnClickAddCoupleConfirm'};
var author$project$Main$OnClickAddSingleCancel = {$: 'OnClickAddSingleCancel'};
var author$project$Main$OnClickAddSingleConfirm = {$: 'OnClickAddSingleConfirm'};
var author$project$Main$OnClickRestart = {$: 'OnClickRestart'};
var author$project$Main$OnInput = function (a) {
	return {$: 'OnInput', a: a};
};
var author$project$Main$OnInputLeft = function (a) {
	return {$: 'OnInputLeft', a: a};
};
var author$project$Main$OnInputRight = function (a) {
	return {$: 'OnInputRight', a: a};
};
...
var author$project$Main$buttonStyles = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
...
var author$project$Theme$hoverColor = A3(rtfeldman$elm_css$Css$rgb, 100, 100, 255);
var author$project$Theme$textColor = A3(rtfeldman$elm_css$Css$rgb, 60, 50, 50);
...
var author$project$Main$buttons = function (inputs) {
	var visibilityValue = (elm$core$List$length(inputs) > 1) ? rtfeldman$elm_css$Css$visibility(rtfeldman$elm_css$Css$visible) : rtfeldman$elm_css$Css$visibility(rtfeldman$elm_css$Css$hidden);
	var styles = rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
				...
				rtfeldman$elm_css$Css$color(author$project$Theme$textColor),
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Css$color(author$project$Theme$hoverColor)
					])),
...
var author$project$Main$inputStyles = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
			...
			author$project$Theme$textColor),
			rtfeldman$elm_css$Css$color(author$project$Theme$textColor),
			rtfeldman$elm_css$Css$outline(rtfeldman$elm_css$Css$none),
			rtfeldman$elm_css$Css$padding(rtfeldman$elm_css$Css$zero),
...
var author$project$Main$results = function (persons) {
	var tuples = A3(
		elm$core$List$map2,
		elm$core$Tuple$pair,
		persons,
	...
	return A2(elm$core$List$map, format, tuples);
};
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Main$OnClickAddSingleConfirm),
																author$project$Main$buttonStyles
															]),
														_List_fromArray(
															[
														...
														_List_fromArray(
															[
																rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Main$OnClickAddSingleCancel),
																author$project$Main$buttonStyles
															]),
														_List_fromArray(
															[
													...
													[
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		rtfeldman$elm_css$Html$Styled$Attributes$value(model.inputLeft),
																		rtfeldman$elm_css$Html$Styled$Events$onInput(author$project$Main$OnInputLeft),
																		author$project$Main$inputStyles
																	]),
																_List_Nil),
																A2(
																...
																_List_fromArray(
																	[
																		rtfeldman$elm_css$Html$Styled$Attributes$value(model.inputRight),
																		rtfeldman$elm_css$Html$Styled$Events$onInput(author$project$Main$OnInputRight),
																		author$project$Main$inputStyles
																	]),
																_List_Nil)
															])),
														...
														_List_fromArray(
															[
																rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Main$OnClickAddCoupleConfirm),
																author$project$Main$buttonStyles
															]),
														_List_fromArray(
															[
														...
														_List_fromArray(
															[
																rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Main$OnClickAddCoupleCancel),
																author$project$Main$buttonStyles
															]),
														_List_fromArray(
															[
									...
									return A2(
										...
										_List_fromArray(
											[
												...
												rtfeldman$elm_css$Html$Styled$div,
												_List_Nil,
												author$project$Main$results(persons)),
												A2(
												rtfeldman$elm_css$Html$Styled$div,
												_List_fromArray(
													[
