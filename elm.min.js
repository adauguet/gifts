...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{inputs: _List_Nil, state: author$project$Main$Default},
...
var author$project$Main$GotSwap = function (a) {
	return {$: 'GotSwap', a: a};
};
		...
		while (true) {
			switch (_n0.b.$) {
				...
				case 'OnClickAddInputAdd':
					var input = _n0.b.a;
					var _n5 = A2(author$project$Main$alreadyExisting, model.inputs, input);
					if (!_n5.b) {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									inputs: A2(elm$core$List$cons, input, model.inputs),
									state: author$project$Main$Default
								}),
							elm$core$Platform$Cmd$none);
					} else {
						var other = _n5;
						var _n6 = A2(elm$core$Debug$log, 'Les prénoms suivants sont déjà utilisés :', other);
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
					}
				case 'OnClickAddInputCancel':
					var _n7 = _n0.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
				...
				case 'OnRandomizePersons':
					if (_n0.a.$ === 'Default') {
						var _n10 = _n0.a;
						var persons = _n0.b.a;
						var avoid = author$project$Link$fromInputs(model.inputs);
...
var author$project$Main$OnClickAddInputCancel = {$: 'OnClickAddInputCancel'};
...
var author$project$Main$buttons = function (inputs) {
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
...
var author$project$Main$results = function (avoid) {
	...
	return A2(elm$core$List$map, format, avoid);
};
							...
							return A2(
								...
								_List_fromArray(
									[
										...
										author$project$Main$buttons(model.inputs)
									]));
						case 'AddSingle':
							var m = _n0.a;
							return A4(author$project$AddSingle$view, m, author$project$Main$AddSingleMsg, author$project$Main$OnClickAddInputAdd, author$project$Main$OnClickAddInputCancel);
						case 'AddCouple':
							var m = _n0.a;
							return A4(author$project$AddCouple$view, m, author$project$Main$AddCoupleMsg, author$project$Main$OnClickAddInputAdd, author$project$Main$OnClickAddInputCancel);
						case 'Computing':
							var current = _n0.a;
							return A2(
								rtfeldman$elm_css$Html$Styled$div,
							...
							return A2(
								...
								_List_fromArray(
									[
										...
										rtfeldman$elm_css$Html$Styled$div,
										_List_Nil,
										author$project$Main$results(avoid)),
										A2(
										rtfeldman$elm_css$Html$Styled$button,
										_List_fromArray(
											[
